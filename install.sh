...
sleep 5
cd /bin || exit
wget https://github.com/Interceptv/scanny/main/chuser > /dev/null 2>&1
wget https://github.com/Interceptv/scanny/main/userscheck > /dev/null 2>&1
...
wget https://github.com/Interceptv/scanny/main/checkuser.py > /dev/null 2>&1
